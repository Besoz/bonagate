...
class PaymentRecordsControllerTest < ActionController::TestCase
  ...
  test "should create payment_record" do
    assert_difference('PaymentRecord.count') do
      post :create, payment_record: { description: @payment_record.description, payment_id: @payment_record.payment_id, value: @payment_record.value }
    end
  ...
  test "should update payment_record" do
    patch :update, id: @payment_record, payment_record: { description: @payment_record.description, payment_id: @payment_record.payment_id, value: @payment_record.value }
    assert_redirected_to payment_record_path(assigns(:payment_record))
  end
