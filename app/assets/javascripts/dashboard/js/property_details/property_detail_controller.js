(function() {
  ...
  function PropertyDetailController(PropertyDetailsServices, propertyDetail, formHelpers,
    ...
    function activate() {
      ...
      vm.newPropertyDetail = propertyDetail;
    ...
    function submitPropertyDetail(form) {
      ...
      if (vm.newPropertyDetail && vm.newPropertyDetail.id) {
    ...
    function createPropertyDetail(form) {
      ...
      PropertyDetailsServices.createPropertyDetail(vm.newPropertyDetail)
        .then(function(res) {
    ...
    function updatePropertyDetail(form) {
      ...
      PropertyDetailsServices.updatePropertyDetail(vm.newPropertyDetail)
        .then(function(res) {
